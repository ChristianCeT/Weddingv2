...
const LastTextMessage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full lg:mx-40 mx-5">
      <div className="text-center font-nametitle font-semibold">
        Queridos amigos y familiares, hoy nos encontramos aquí, rodeados de amor
        y esperanza, para celebrar la unión de nuestras vidas. Cada uno de
        ustedes ocupa un lugar especial en nuestros corazones, y su presencia
